...
import com.cg.pa.exception.TransactionException;
import com.cg.pa.service.BankService;
import com.cg.pa.service.BankServiceImpl;
...
public class MainUI {
	...
	public static void main(String[] args) {
		...
		String choice;
		while (true) {
			System.out.println("\nWelcome to Bank App for Our Bank");
	...
	private static void openAccount(Customer customer) {
		// TODO Auto-generated method stub
		System.out.println("...Hello " + customer.getAccHolderName()
				+ "...\n...Welcome to our Bank...");
